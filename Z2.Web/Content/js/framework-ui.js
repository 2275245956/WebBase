...
$.currentWindow = function () {
    var tabId = top.$(".layui-this").attr("lay-id");
    var frameId = "x-iframe-" + tabId;
    return top.frames[frameId];
}
$.closeCurrentWindow = function () {
    var tabId = top.$(".layui-this").attr("lay-id");
    return top.closeCurrentWindow(tabId);
}
$.addNewWindow = function (title, url) {
    return top.addNewWindow(title, url);
}
$.browser = function () {
...
$.modalOpen = function (options) {
    ...
    top.layer.open({
        ...
        content: options.url,//[options.url, 'no'],
        btn: options.btn,
        btnclass: options.btnclass,
        yes: function (index, layero) {            
            options.callBack(layero.find('iframe')[0]['name']);//(options.id)
...
$.fn.authorizeButton = function () {
    var moduleId = top.$(".Z2_iframe:visible").attr("id").substr(6);
...
$.fn.dataGrid = function (options) {
    ...
    if (options.onSelectRow != null) {
        options._onSelectRow = options.onSelectRow;
    }
    options["onSelectRow"] = function (rowid) {
        ...
        if (options._onSelectRow != null) {
            options._onSelectRow(rowid);
        }
    };
