...
UE.I18N['ja-jp'] = {
    ...
    'contextMenu':{
        ...
        'insertparagraphbefore': "行の前に挿入",
        'insertparagraphafter': '行の後に挿入',

        'inserttable': 'テーブルを挿入',

        'insertcaption': 'キャプション挿入',
        'deletecaption': 'キャプション削除',
        ...
        'insertrownext': '次の行を挿入',
        'insertcolnext': '次の列を挿入',
        ...
        'borderbk': '行背景色',
        'setcolor': 'インターレス色',
        'unsetcolor': 'インターレス色を取消',
        'setbackground': '背景インターレス色',
        'unsetbackground': '背景インターレス色を取消',
        'redandblue': '青と赤',
        'threecolorgradient': '3色グラデーション',

        'copy': "コピー(Ctrl + c)",
        'copymsg': "代わりに'Ctrl + c'を使用してください!",
        'paste': "貼り付け(Ctrl + v)",
        'pastemsg': "代わりに'Ctrl + v'を使用してください!",
    ...
    insertimage:{
        'static':{
            ...
            'imgType':{title:"ImageType", options:["News", "Wallpaper", "emotions", "photo"]},
    ...
    help:{
        'static':{
            ...
            'lang_Txt_redo':'やり直し',
            'lang_Txt_italic':'斜体',
            'lang_Txt_underline':'下線',
            'lang_Txt_selectAll':'全選択',
...
//            lang_tab_searchV:"Search",
    ...
    'edittable':{
        'static':{
            ...
            'lang_insertCaption': 'ヘッダー行あり ',
            'lang_insertTitle': 'タイトル行あり ',
            'lang_orderbycontent': "並び順変更可 ",

            'lang_tableSize': 'テーブルサイズ自動調整',
            'lang_autoSizeContent': 'セルの文字で調整 ',
            'lang_autoSizePage': 'ページ幅で調整 ',

            'lang_example': '例',
            'lang_borderStyle': '罫線の色',
            'lang_color': '色:'
        },
